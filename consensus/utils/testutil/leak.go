...
running(leaking) after all tests.
	...
	import "github.com/rfyiamcool/raft_kvs/consensus/utils/testutil"
...
func interestingGoroutines() (gs []string) {
	...
	for _, g := range strings.Split(string(buf), "\n\n") {
		...
		if stack == "" ||
			...
			strings.Contains(stack, "github.com/rfyiamcool/raft_kvs/consensus/utils/testutil.interestingGoroutines") ||
			strings.Contains(stack, "github.com/rfyiamcool/raft_kvs/consensus/utils/logutil.(*MergeLogger).outputLoop") ||

...
import (
	...
	"github.com/rfyiamcool/raft_kvs/consensus/utils/logutil"
...
func TestPackageLogger(t *testing.T) {
	...
	l := logutil.NewPackageLogger("github.com/rfyiamcool/raft_kvs", "consensus/utils/logutil")

	r := capnslog.MustRepoLogger("github.com/rfyiamcool/raft_kvs")
